...
static constexpr auto qt_meta_stringdata_ZN10TabManagerE = QtMocHelpers::stringData(
    "TabManager",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10TabManagerE[] = {
...
Q_CONSTINIT const QMetaObject TabManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10TabManagerE.offsetsAndSizes,
    qt_meta_data_ZN10TabManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10TabManagerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TabManager, std::true_type>,
        // method 'handleNewTabButtonClick'
...
void TabManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->handleNewTabButtonClick(); break;
        default: ;
        }
    }
    (void)_a;
...
void *TabManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10TabManagerE.stringdata0))
